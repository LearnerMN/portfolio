...
export const SKILLS: SkillInfo[] = [
  { 
    ...
    icon: "fa fa-globe",
    list:[ 
      { name: "Kotlin", img:"./assets/img/logos/kotlin_lang.png" },
  ...
  { 
    ...
    list:[ 
      ...
      { name: "Moya", img:"./assets/img/logos/moya_ios.png" },
      { name: "CocoaPods", img:"./assets/img/logos/cocoapods.png" }, 
      { name: "Viper", img:"./assets/img/logos/swift.png" }, 
  ...
  { 
    ...
    icon: "fa fa-wrench",
    list:[ 
      { name: "CircleCI", img:"./assets/img/logos/circleci.png" },
      { name: "Fastlane", img:"./assets/img/logos/fastlane.png" },
      { name: "JIRA", img:"./assets/img/logos/jira.jpg" },
